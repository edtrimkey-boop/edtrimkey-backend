...
// ==========================================
      ...
      case "getJobTimeline":
        ...
        let historyArr = jobData.meta_data?.history || [];
        
        // If history is completely empty, construct a dynamic "Genesis" event based on creation
        if (historyArr.length === 0) {
            let createdDate = new Date(jobData.created_at).toLocaleString('en-IN', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' });
            historyArr.push({
                type: 'completed',
                actorName: 'System',
      ...
      case "addJobTimelineEvent":
        ...
        // Ensure legacy support for older UI rendering
        ...
        // -------------------------------------------------------------
        // TODO: Push to 'notifications' table or send FCM Push Notification
